...
void DiffuseShader::ProcessVertex(const VertexInfo& in, VertexToPixel& out) const
{
...
void DiffuseShader::ProcessPixel(const VertexToPixel& in, PixelInfo& out) const
{
